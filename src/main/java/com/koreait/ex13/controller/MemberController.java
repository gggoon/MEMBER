...
public class MemberController {
	...
	@PostMapping(value = "idCheck", produces="application/json; charset=UTF-8")  // json 데이터로 받아오기
	@ResponseBody
	...
	*/
	...
	public String login(HttpServletRequest request) {
		// public String login(Member member, HttpSession session) {   이렇게 할수도 있다아
